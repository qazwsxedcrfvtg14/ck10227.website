...
<!-- 
function channel(){ 
window.open("indexx.php","","channelmode,scrollbars") 
} 
//--> 
</script> 
...
<tr>
		<td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
			<div align="center">
			  ...
			  <table border="0" >
			    <tr>
                <td height="420" width="100" border="0" >
			      
			      <p align="center">
                  <iframe name="left" src="index8.php" width="100" scrolling="no" border="0" frameborder="0" height="420">
			        
			        您的瀏覽器不支援內置框架或目前的設定為不顯示內置框架。
			        </iframe>
	            </td>
			<td height="420" width="760" border="0" >
			    <p align="center">
			<iframe name="main" src="html/index7.php" width="760" border="0" frameborder="0" height="420">
			      
			      您的瀏覽器不支援內置框架或目前的設定為不顯示內置框架。
			      </iframe>
			      </td>
			<td height="420" width="100" border="0" >
			<iframe name="right" src="html/wedget.php" width="100" scrolling="no" border="0" frameborder="0" height="420">
