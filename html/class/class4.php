...
<? 
if($P_Class_Thing){
	echo"導師　林信安　H:(02)29301554　M:0936843135";
    }
?>
<br>
<table border="0" bordercolor="#99CC00" cellspacing="0" cellpadding="5" >
<tr bgcolor="202020" cellspacing="0" cellpadding="10"><td align="right">　座號</td><td>姓名</td><td>家中電話</td><td>手機</td><td>電子郵件　</td></tr>
<? 
	if($P_Class_Thing){
if((@file_exists("data/list2.txt")))
{
	$fileopen = fopen("data/list2.txt","r");
